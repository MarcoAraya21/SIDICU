...
class Index extends Component {
  constructor (props) {
    ...
    handleSubmit() {
        ...
        if(Object.keys(validaciones2.plan).length == 0 && Object.keys(validaciones2.carrera).length == 0)
        {
            ...
            if(this.state.plan_estudios.nueva_oferta == true)
            {
                ...
                .then(data => {
                    fetch(`/api/informacion_basica/${this.props.match.params.id}`, {
                        method: 'put',
                        headers: {
                            'Accept': 'application/json',
                            'Content-Type':'application/json'
    ...
    getPlanEstudio() {
        ...
        axios.get(`/api/informacion_basica/${this.props.match.params.id}`).then((
            ...
            if( response.status == 403 )
            {
                swal({
                    ...
                    text: 'Seras Redireccionado en 5 Segundos',
                    icon: "info",
                    timer: 5000,
                    buttons: false,
                    closeOnEsc: false,
            ...
            else
            {
                if( response.status == 200)
                {
                    this.setState({
                        plan_estudios: {
                            ...response.data,
                            tipo_grado_id: response.data.carrera.tipo_grado_id,
                            asesor_id: response.data.asesor_uic.id,
                            academico_id: response.data.coordinador.id
                        },
                        otros:{
                            titulo_intermedio: response.data.titulo_intermedio ? true : false,
                            minor: response.data.minor ? true : false,
                            diploma: response.data.diploma ? true : false
                        }
                    })
                    if(response.data.nueva_oferta == 1)
                    {
                        this.setState({
                            nueva_carrera:{
                                nombre: response.data.carrera.nombre,
                                titulo: response.data.carrera.titulo,
                                escuela_id: response.data.carrera.escuela_id,
                                grado_id: response.data.carrera.grado_id
                            }
                        })
                    }
                    this.getCarreras();
    ...
    getCarreras() {
        axios.get('/api/all_carreras').then((
            response
        ) =>{
                this.setState({
    ...
    getAsesor() {
        axios.get('/api/all_asesores').then((
            response
        ) =>{
                this.setState({
    ...
    render() {
        ...
        return (
            this.state.plan_estudios.id ? 
                <div className='container py-4'>
                    <ReactNotification ref={this.notificationDOMRef}/>
                    <ol className="breadcrumb pull-right">
                        <li className="breadcrumb-item active">Inicio</li>
                    </ol>
                    <h1 className="page-header">Editar Plan de Estudios {this.state.plan_estudios.id}</h1>
                        ...
                        <div className="col-12">
                            ...
                            <div className="col row mb-2">
                                ...
                                <div className="col-6">
                                    ...
                                    <select value={this.state.plan_estudios.tipo_formacion_id || ""}
                            ...
                            <div className="col row mb-2">
                                <div className="col-4">
                                    ...
                                    <select value={this.state.plan_estudios.tipo_plan_id || ""}
                            ...
                            </div>
                            {
                                this.state.plan_estudios.tipo_grado_id != 0 &&
                                    ...
                                    <div className="col row mb-2">
                                        <div className="col-4">
                                            <label>Carrera</label>
                                            <select value={this.state.plan_estudios.carrera_id || ""}
                                    ...
                                    <div className="col row mb-2">
                                        ...
                                        <div className="col-4">
                                            <label>Escuela de la Carrera</label>
                                                <select value={this.state.nueva_carrera.escuela_id || ""}
                                        ...
                                        <div className="col-4">
                                            <label>Grado de la Carrera</label>
                                                <select value={this.state.nueva_carrera.grado_id || ""}
                            ...
                            <div className="col row mb-2">
                                <div className="col-3">
                                    <label>Jornada</label>
                                    <select value={this.state.plan_estudios.jornada_id || ""}
                                ...
                                <div className="col-3">
                                    ...
                                    <select value={this.state.plan_estudios.modalidad_id || ""}
                            ...
                            <div className="col row mb-2">
                                <div className="col-6">
                                    ...
                                    <select value={this.state.plan_estudios.asesor_id || ""}
                                ...
                                <div className="col-6">
                                    ...
                                    <select value={this.state.plan_estudios.academico_id || ""}
                    ...
                    <div align="right" className="mt-2">
                        {
                            this.state.guardando ?
                                <button type="button" className="btn btn-primary disabled">
                                    <i className="fas fa-spinner fa-pulse p-r-5" ></i>Guardando Plan
                                </button>
                            :                             
                                <button type="button" className="btn btn-primary" onClick={() => this.handleSubmit()}>
                                    <i className="fas fa-plus p-r-5" ></i>Guardar Plan
                                </button>
                        }
                    </div>
                </div>
            :
            "No tiene Acceso a este Plan"
        );
    }
}
