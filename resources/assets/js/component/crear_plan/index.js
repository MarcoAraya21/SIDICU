                    ...
                    <div className="col-12">
                        ...
                        <div className="col row mb-2">
                            <div className="col-6">
                                ...
                                <select defaultValue={""}
                                    className={ "form-control " + (this.state.errores.plan.uic_id && 'is-invalid')} 
                                ...
                                {this.state.errores.plan.uic_id &&
                                <div className="invalid-feedback">{this.state.errores.plan.uic_id}</div>}
                            </div>
                            <div className="col-6">
