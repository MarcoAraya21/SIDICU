                ...
                <TreeNode key={i} label={<StyledNode><h6>Competencia {i+1}</h6>{competencia.descripcion}</StyledNode>}>
                    {competencia.nivel_competencias.map((nivel_competencia,i) =>
                        <TreeNode key={i} label={<StyledNode>
                            <h6 data-toggle="collapse" class="pointer-cursor" data-target={`#nivel${nivel_competencia.id}`}>
                              Nivel {i+1}
                            </h6>
                            <p id={`nivel${nivel_competencia.id}`} class="collapse">
                            ...
                            {nivel_competencia.logro_aprendizajes.map((logro_aprendizaje,i) =>
                                <TreeNode key={i} label={<StyledNode>
                                          ...
                                          <h6 data-toggle="collapse" class="pointer-cursor" data-target={`#logro${logro_aprendizaje.id}`}>
                                            Logro de Aprendizaje {i+1}
                                          </h6>
                                          <div id={`logro${logro_aprendizaje.id}`} class="collapse">
