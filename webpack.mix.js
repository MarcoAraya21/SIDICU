...
// Estilos personalizados
	//main
	mix.sass('resources/assets/sass/estilos.scss', 'public/assets/css/estilos.css')
	//footer
	mix.sass('resources/assets/sass/footer.scss', 'public/assets/css/default/footer.css')

// img
mix.copy('resources/assets_template/img/', 'public/assets/img/');

// img
mix.copy('resources/assets_template/css/', 'public/assets/css/');
...
// React components
mix.react('resources/assets/js/Router.js', 'public/assets/js/Router.js')